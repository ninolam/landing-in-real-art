...
const InvestmentCardDetail = () => {
  return (
    ...
    <div className={styles["frame-3387"]}>
  ...
  <div className={styles["frame-3387__frame-3385"]}>
    <div className={styles["frame-3387__frame-3379"]}>
      <svg
        className={styles["frame-3387__group-36600"]}
        width="22"
        height="22"
        viewBox="0 0 22 22"
        fill="none"
    ...
    <div className={styles["frame-3387__frame-3380"]}>
      <svg
        className={styles["frame-3387__group-366012"]}
        width="22"
        height="22"
        viewBox="0 0 22 22"
        fill="none"
    ...
    <div className={styles["frame-3387__frame-3381"]}>
      <svg
        className={styles["frame-3387__group-366002"]}
        width="22"
        height="22"
        viewBox="0 0 22 22"
        fill="none"
    ...
    <div className={styles["frame-3387__frame-3382"]}>
      <div className={styles["frame-3387__group-366013"]}>
        ...
        <svg
          className={styles["frame-3387__vector-75"]}
          width="9"
          height="6"
          viewBox="0 0 9 6"
          fill="none"
        ...
        <div className={styles["frame-3387__group-366003"]}>
          ...
          <svg
            className={styles["frame-3387__group-366004"]}
            width="22"
            height="22"
            viewBox="0 0 22 22"
            fill="none"
    ...
    <div className={styles["frame-3387__frame-3383"]}>
      <svg
        className={styles["frame-3387__group-36602"]}
        width="22"
        height="22"
        viewBox="0 0 22 22"
        fill="none"
      ...
      <div
        className={styles["frame-3387__possibilit-de-vendre-sur-notre-marketplace-exclusive"]}
      >
    ...
    <div className={styles["frame-3387__frame-3384"]}>
      <svg
        className={styles["frame-3387__group-366022"]}
        width="22"
        height="22"
        viewBox="0 0 22 22"
        fill="none"
