...
function DropPanel() {
  return (
    ...
    <div className="frame-6">
        ...
        <div className="text-wrapper-3">Fin du drop dans</div>
        </div>
        <div className="frame-8">
        <div className="text-wrapper-4">65J 20H</div>
        </div>
    </div>
    <div className="frame-9">
        ...
        <div className="frame-11">
            ...
            <div className="frame-12">
                <div className="text-wrapper-5">Détail</div>
                <Arrow21 className="arrow" />
            </div>
            </div>
            <button className="button-2">
            <div className="text-wrapper-6">Acquérir</div>
            </button>
        </div>
        <div className="frame-11">
            <div className="frame-3">
